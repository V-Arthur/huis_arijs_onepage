...
/* ------- backup
	function getUitvaartwinkelAfbeeldingen(beginpunt, richting, categorie){
		$.ajax({
			url: "php/indexData.php",
			data: {uitvaartwinkelAfbeelding: 'getUitvaartwinkelAfbeeldingen', categorie: categorie},
			type: 'post',
			dataType: "json",
			success: function(output) {
				var $output = output;
...
*/
	getUitvaartwinkelId(2);

	function getUitvaartwinkelId(categorie){
		$.ajax({
			url: "php/indexData.php",
			data: {uitvaartwinkelId: 'getUitvaartwinkelId', categorie: categorie},
			type: 'post',
			dataType: "json",
			success: function(output) {
				var $output = output;
	...
	$("#uitvaartwinkelAfbeelding1").on("click", function(){
        ...
        //console.log(bg);
        groteAfbeeldingWeergeven(bg, $uitvaartwinkelbeschrijving[0], $uitvaartwinkelprijs[0], $uitvaartwinkelrangnummer[0]);
