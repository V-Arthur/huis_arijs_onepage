...
Modified in 2015 by Ekaterina Bourgois to improve the performance
 */
(function ($, undefined) {
    "use strict";
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        prepareOpts: function (opts) {
            ...
            opts = $.extend({}, {
                ...
                formatNoMatches: function (input) { return /*"No matches found"*/input;  },
        ...
        updateResults: function (initial) {
            ...
            opts.query({
                ...
                if (data.results.length === 0) {
                    //test
                    //parts.push("<li class='select2-result'>");
                    //parts.push(search.val());
                    //parts.push("</li>"+"<li class='select2-no-results'>" + opts.formatNoMatches(search.val()) + "</li>");
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            return $("<div></div>", {
                ...
                // dropdown span knop"   <div><b></b></div>" ,
                "</a>",
                "    <div class='select2-drop' style='display:none;'>" ,
                "   <div class='select2-search'>" ,
                "       <input type='text' autocomplete='off'  style='width:250px; height:20px'/>" ,
                "   </div>" ,
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            return $("<div></div>", {
                ...
                "    <input type='text' class='inputx' autocomplete='off' style='width:250px;height:20px'>" ,
                "  </li>" ,
                "</ul>" ,
                "<div class='select2-drop' style='display:none;'>" ,
                "   <ul class='select2-results'>" ,
        ...
        addSelectedChoice: function (data) {
            var choice,
                ...
                parts,
                val = this.getVal();
            var cl_opt = id.replace("#", "_");
            parts = ["<li class='select2-search-choice opt_"+cl_opt+"'>",
