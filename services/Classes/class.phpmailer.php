...
/*
    ...
    require_once(locate_file('services/Classes/class.phpmailer.php'));
    $mail = new PHPMailer();
    foreach(explode(',',$emails) as $email) $mail->AddAddress("$email", "");
    $mail->SetFrom("no-reply@localhost", $subject);
    $mail->AddReplyTo("no-reply@localhost",$subject);
